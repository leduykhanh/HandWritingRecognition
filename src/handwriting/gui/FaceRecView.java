...
public class FaceRecView extends JFrame implements ActionListener {
	...
	private void addWidgets() {
		...
		fileChooseButton = new JButton("Select a file");
		dirChooseButton = new JButton("Select a the data");
		...
		thresholdLabel    = new JLabel("threshold distance:");
                titleLabel = new JLabel("Hand Writing Recognition Program");
		...
		addComponent(titleLabel, 0, 0, 2, 1, GridBagConstraints.CENTER,GridBagConstraints.NONE);
		addComponent(fileChooseButton, 0, 1, 2, 1, GridBagConstraints.CENTER,GridBagConstraints.NONE);
		addComponent(selectedFileName, 0, 2, 2, 1, GridBagConstraints.CENTER,GridBagConstraints.NONE);
		addComponent(dirChooseButton, 0, 3, 2, 1, GridBagConstraints.CENTER,GridBagConstraints.NONE);
		addComponent(selectedDirName, 0, 4, 2, 1, GridBagConstraints.CENTER,GridBagConstraints.NONE);
